...
class APIError extends Exception {
	...
	public static function getErrorById($id) {
		...
		// User errors
		case 1001: $msg = 'User ID must be an integer'; break;
		...
		case 1005: $msg = 'Name exceeds max length'; break;
		...
		// Group errors
		case 1101: $msg = 'Group name exceeds max length'; break;
		case 1102: $msg = 'Group name contains invalid characters'; break;
		case 1103: $msg = 'Invalid permissions value'; break;
